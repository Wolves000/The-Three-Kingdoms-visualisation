...
var infor = [
    ["208-09-03", "曹操到达新野，刘备弃樊南逃"],
    ["208-09-04", "曹操急速追赶，在当阳县的长坂追上刘备。刘备抛下妻子及儿子，与诸葛亮、张飞、赵云等数十人骑马逃走，曹操俘获了大量的人马辎重"],
    ["208-09-05", "曹操进军江陵，任命刘琮为青州刺史，封为列侯"],
    ["208-09-06", "曹操顺流东下"],
    ["208-10-04", "孙权任命周瑜、程普为左、右督，各自带领万余人与刘备合力迎战曹操"],
    ["208-12-01", "刘备驻军樊口，程普与周瑜分别任左右都督，与刘备军结成孙刘联军。"],
    ["208-12-07", "孙刘联军逆水而上，行至赤壁，与正在渡江的曹军相遇"],
    ["208-12-09", "曹操大败，从华容道步行撤退"],
    ["208-12-15", "周瑜、刘备军队水陆并进，一直尾随追击，曹操逃回江陵"]
];
//地图中心点以及缩放级别等
var bmap = {
    center: [112.434612, 30.049044],
    zoom: 8,
    roam: true,
    mapStyle: {
        styleJson: [{
